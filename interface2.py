...
class MyGUI(QMainWindow):
    def __init__(self):
        ...
        top_left_label.setPixmap(top_left_pixmap.scaled(
        ...
        bottom_left_label.setPixmap(bottom_left_pixmap.scaled(
        ...
        for i, image_file in enumerate(image_files):
            ...
            # Use i-1 to access the corresponding label text
            text_label = QLabel(labels[i - 1])
            ...
            # Add the image and label layout to the grid layout
            right_layout.addLayout(image_layout, row, col)
