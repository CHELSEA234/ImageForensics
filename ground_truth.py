...
# ground_truth_text_dir = '/user/guoxia11/cvlshare/cvl-guoxia11/RED_diffusion/Adjcent_Matrix/'
...
# 			"LDM", "DIFFAE", "ADM_G_512"]
# set_4 = ["GFLM", "IMAGE_GPT", "LSGAN", "MADE", "PIX2PIX", "PROG_GAN", "RSGAN_REG", "SEAN", 
# 			"STYLEGAN", "SURVAE_FLOW_NONPOOL", "WGAN_DRA", "YLG",
# 			"SDEdit", "DDPM_32", "ADM_G_128"]

set_1 = ["ADV_FACES", "BETA_B", "BETA_TCVAE", "DAGAN_C", "DRGAN", "FGAN", 
			"PIXELCNN", "PIXELCNN_PP", "RSGAN_HALF", "STARGAN", "VAE_GAN", "DDPM_256", 
			"IDDPM_64", "DDiFFGAN_32"]
set_2 = ["AAE", "ADAGAN_C", "BEGAN", "BETA_H", "COCO_GAN", "CRAMER_GAN", 
			"DEEPFOOL", "DRIT", "FVBN", "ADM_G_64", "DDPM_32",
			"GLIDE"]
set_3 = ["CRGAN_C", "FACTOR_VAE", "FGSM", "ICRGAN_C", "LOGAN", 
			"PIXELSNAIL", "STARGAN_2", "SURVAE_FLOW_MAXPOOL", "VAE_FIELD",
			"LDM", "DIFFAE", "ADM_G_512"]
set_4 = ["GFLM", "IMAGE_GPT", "LSGAN", "MADE", "PROG_GAN", "RSGAN_REG", "SEAN", 
			"STYLEGAN", "SURVAE_FLOW_NONPOOL", "WGAN_DRA", 
			"SDEDIT", "DDPM_32", "ADM_G_128"]
...
# file_path = '/user/guoxia11/cvlshare/cvl-guoxia11/RED_diffusion/data_final_140/train/*'
# folder_lst = glob(file_path)
# folder_lst.sort()
folder_complete_tmp  = glob("/user/guoxia11/cvlshare/cvl-guoxia11/RED_diffusion/data_final_140/train/*")
...
# print(set(folder_complete_list) <= set(folder_lst))
# print(list(set(folder_complete_list) - set(folder_lst)))
