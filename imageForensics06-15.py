...
if __name__ == '__main__':
        ...
        # Customize the size of the main window
        mainWindow.resize(800, 600)

        # Customize the size and position of the drag label
        mainWindow.dragLabel.setMinimumSize(400, 500)
        mainWindow.dragLabel.setGeometry(50, 50, 400, 400)
